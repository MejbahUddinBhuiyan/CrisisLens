<x-app-layout>
        ...
        <div style="display:flex; justify-content:space-between; align-items:center; gap:16px; flex-wrap:wrap;">
            <div>
                ...
                <p style="margin-top:6px; font-size:14px; color:#64748b;">
                    Search, filter, and respond to verified citizen reports.
                    <br>
                    যাচাইকৃত নাগরিক রিপোর্ট সার্চ, ফিল্টার এবং সাড়া দিন।
                </p>
            </div>
    ...
    <div style="padding:32px 0;">
        <div style="max-width:1250px; margin:0 auto; padding:0 16px;">
            ...
            <form method="GET"
                  action="{{ route('responder.reports.index') }}"
                ...
                @else
                    <div style="padding:42px 24px; text-align:center;">
                        <h3 style="font-size:20px; font-weight:900; color:#172033;">
                            No responder reports found (কোনো রেসপন্ডার রিপোর্ট পাওয়া যায়নি)
                        </h3>
