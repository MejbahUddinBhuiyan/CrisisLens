<x-app-layout>
    <x-slot name="header">
        <div>
            <h2 style="font-size:22px; font-weight:700; color:#172033;">
                Edit Emergency Safety Guide (জরুরি নিরাপত্তা গাইড সম্পাদনা)
            </h2>
            <p style="margin-top:6px; font-size:14px; color:#64748b;">
                Update public emergency safety guide content.
            </p>
        </div>
    </x-slot>
    ...
    <div style="padding:32px 0;">
        <div style="max-width:900px; margin:0 auto; padding:0 16px;">
            ...
            <form method="POST"
                  action="{{ route('authority.emergency-documents.update', $emergencyDocument) }}"
                ...
                @include('authority.emergency-documents.partials.form', [
                    ...
                    'buttonText' => 'Update Guide (গাইড আপডেট করুন)'
                ])
            </form>
        </div>
    </div>
